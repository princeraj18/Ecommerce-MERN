    ...
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh]'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]' >
        ...
        <input type="text" placeholder='Street' className='border border-gray-300 rounded py-1.5 px-3.5 w-full' name="" id="" />
         ...
         <div className=' flex gap-3'>
              <input type="text" placeholder='Pincode' className='border border-gray-300 rounded py-1.5 px-3.5 w-full' name="" id="" />
                 <input type="text" placeholder='Country' className='border border-gray-300 rounded py-1.5 px-3.5 w-full' name="" id="" />

        </div>
           <input type="number" placeholder='Phone Number' className='border border-gray-300 rounded py-1.5 px-3.5 w-full' name="" id="" />
      </div>
